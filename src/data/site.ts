export const siteContent = {
	...
	ecosystem: {
		...
		intro: 'A clear view of the products and capabilities that support the player experience and day-to-day operation.',
		groups: [
			{
				id: 'players',
				number: '01',
	...
	journey: {
		...
		intro: 'A journey map—not a claim that every step is automated or integrated. Each operator’s setup depends on its products, providers and operating model.',
		steps: [
	...
	partners: {
		...
		intro: 'Operators work with providers, suppliers, labs and third-party integrators. These are part of the wider operating context—not ZGames products.',
	...
	contact: {
		...
		prompt: 'Bring the questions that matter to your team: operating model, player journey, existing providers and areas to explore.',
